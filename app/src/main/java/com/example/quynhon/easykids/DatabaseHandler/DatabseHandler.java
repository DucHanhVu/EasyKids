package com.example.quynhon.easykids.DatabaseHandler;
...
public class DatabseHandler extends SQLiteOpenHelper {
    ...
    public static final String dbPath = "/data/data/com.example.quynhon.easykids/databases/";
    public static final String dbName = "easykid_db.sqlite";
